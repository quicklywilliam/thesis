...
\end{insettable_wide}
Using these rules, we have a systematic function $\sigma$ for renaming identifiers in a process.
...
\]
Here we see that both processes will agree in their output.  Note that no substitutions were necessary since $\sends{c}{}$ is simply a\refmargin{handshake} handshake signal.
