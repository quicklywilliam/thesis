...
In 1978 C.A.R. Hoare introduced an early process algebra called Communicating Sequential Processes (\!\inidx{CSP})\cite{hoar78}.  In the 1980's, Robin Milner introduced his similar Calculus of Communicating Systems (\!\inidx{CCS})\cite{miln82}.  
