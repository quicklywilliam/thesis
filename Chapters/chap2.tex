...
The idea is that since these terms are free, when the process is used as a component in a larger system, we can have other components that expose the same channels.  
