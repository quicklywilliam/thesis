...
This is due to a classic issue in concurrent systems, a \defmargin{race condition}, which means that the output of a system is dependent on the timing of computations in the system.  
