...
We say that a process $Q$ with interface $Q(\tuple{V})$ \defmargin[exposes]{exposed channels} the names $\tuple{V}$.  
...
\begin{definition}{Action}\label{apiactionrules}
	...
	\end{tabular}\end{center}
\end{definition}
\note{FINAL CHANGE HERE}In the preconditions above, we have subtly extended our notion of bound names to the case of actions.  
